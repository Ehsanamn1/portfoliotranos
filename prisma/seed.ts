...
async function main(){
 const projects=[
  {slug:"tranos-ai",title:"Tranos AI",description:"AI product experience and web platform.",category:"AI Product",year:2026,featured:true,published:true,imageUrl:"/work/tranos-ai.svg",sortOrder:1},
  {slug:"brand-system",title:"Brand System",description:"Identity and digital presence for a technology-first brand.",category:"Branding",year:2026,featured:true,published:true,imageUrl:"/work/brand-system.svg",sortOrder:2},
  {slug:"atlas-commerce",title:"Atlas Commerce",description:"Commerce experience with automation at the core.",category:"E-commerce",year:2026,featured:true,published:true,imageUrl:"/work/atlas-commerce.svg",sortOrder:3},
